...
- **Adoption:** Recommendation utilization exceeded 90% in several deployments, indicating strong user trust and alignment with workflows :contentReference[oaicite:0]{index=0}  
- **Field Productivity:** 93% increase in top-tier accounts achieving call plan targets :contentReference[oaicite:1]{index=1}  
- **Engagement:**  
  - 4x increase in rep-triggered email send rates  
  - 14x increase in marketing consent opt-ins :contentReference[oaicite:2]{index=2}  
- **Scale:** Deployed across global teams, supporting thousands of users and adapting to regional engagement patterns :contentReference[oaicite:3]{index=3}  
