...
<Image src="./fig0300a.jpg" alt="frequentist probability" />
...
{% capture text-capture %}
<Image src="./output_9_0.png" alt="Rademacher Discrete Random Variables" />

<Image src="./output_9_1.png" alt="Rayleigh Continuous Random Variables" />
{% endcapture %}
...
<Image src="./output_14_1.png" alt="single dice distribution" />
...
<Image src="./output_17_0.png" alt="Dice 1 rolls" />

<Image src="./output_17_1.png" alt="Dice 2 rolls" />
...
{% capture text-capture %}
<Image src="./output_20_0.png" alt="uniform distribution" />
{% endcapture %}
...
{% capture text-capture %}
<Image src="./output_23_0.png" alt="continuous distribution" />
{% endcapture %}
...
<Image src="./output_26_1.png" alt="Normal distribution" />
...
<Image src="./fig0305a.png" alt="Conditinoal probability" />
...
<Image src="./output_47_1.png" alt="Expectation Plot" />
...
<Image src="./output_50_1.png" alt="Variance Plot" />
...
<Image src="./output_63_1.png" alt="Bernoulli Distribution" />
...
<Image src="./output_66_1.png" alt="Multinomial Distribution" />
...
{% capture text-capture %}
<Image src="./output_70_0.png" alt="Gaussian Distribution" />
{% endcapture %}
...
{% capture text-capture %}
<Image src="./output_72_0.png" alt="multivariate normal distribution" />
{% endcapture %}
...
{% capture text-capture %}
<Image src="./output_75_0.png" alt="Exponential distribution" />
{% endcapture %}
...
{% capture text-capture %}
<Image src="./output_77_0.png" alt="Laplace distribution" />
{% endcapture %}
...
{% capture text-capture %}
<Image src="./output_80_0.png" alt="Dirac distribution" />
{% endcapture %}
...
{% capture text-capture %}
<Image src="./output_85_0.png" alt="Mixtures of distribution" />
{% endcapture %}
...
{% capture text-capture %}
<Image src="./output_92_0.png" alt="logistic function" />
{% endcapture %}
...
{% capture text-capture %}
<Image src="./output_94_0.png" alt="softplus function" />
{% endcapture %}
...
<Image src="./fig0310a.PNG" alt="sigmoid and softplus properties" />
...
<Image src="./fig0312a.jpg" alt="Measure Theory Example" />
...
<Image src="./output_104_1.png" alt="Entropy Plot" />
...
{% capture text-capture %}
<Image src="./output_108_0.png" alt="Shannon Entropy Plot" />
{% endcapture %}
...
<Image src="./fig0314a.jpeg" alt="Graphical Theory Intro" />
...
<Image src="./fig0314b.PNG" alt="Directed graph example" />
...
<Image src="./fig0314d.png" alt="Directed graph example dr who" />
...
<Image src="./fig0314c.PNG" alt="Undirected graph example" />
...
<Image src="./fig0314e.png" alt="Undirected graph example facebook" />
