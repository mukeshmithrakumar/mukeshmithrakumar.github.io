...
heroImage: ./computer-vision-object-detection.png
tags:
  - cv
...
<MathBlock formula={String.raw`IoU = \frac{\text{Area of Overlap}}{\text{Area of Union}} \tag{1}`} />
...
![Miss rate vs FPPI plot](./20190630a.png)
...
![Attentional cascade](./20190630c.png)
...
![Classifier networks](./20190630d.png)
...
![R-CNN architecture](./20190630e.png)
...
![Spatial Pyramid Pooling](./20190630f.png)
...
<MathBlock formula={String.raw`L(p,u,t^u,v) = L_{cls}(p,u) + \lambda[u \geq 1]L_{loc}(t^u, v) \tag{2}`} />

This multi-task loss is the rate of sum of classification loss:

<MathBlock formula={String.raw`L_{cls}(p,u) = -logp_u \tag{3}`} />

And bounding box regression loss:

<MathBlock formula={String.raw`L_{loc}(t^u,v) = \sum_{i \in (x,y,w,h)}smooth_{L_1} (t_i^u - v_i) \tag{4}`} />
...
![Region Proposal Network](./20190630h.png)
...
![Multi Path architecture](./20190630i.png)
...
![Region-Based Fully Convolutional Network](./20190630j.png)
